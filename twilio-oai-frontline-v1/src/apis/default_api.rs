...
pub async fn update_user(
    ...
    let is_available = params.is_available;
    ...
    if let Some(local_var_param_value) = is_available {
        local_var_form_params.insert("IsAvailable", local_var_param_value.to_string());
    }
