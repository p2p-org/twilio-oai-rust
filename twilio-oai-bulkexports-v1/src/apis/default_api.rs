...
///
pub async fn create_export_custom_job(
    configuration: &configuration::Configuration,
    params: CreateExportCustomJobParams,
) -> Result<ResponseContent<CreateExportCustomJobSuccess>, Error<CreateExportCustomJobError>> {
    ...
    let local_var_uri_str = format!(
        ...
        ResourceType = crate::apis::urlencode(resource_type)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateExportCustomJobSuccess> =
        ...
        let local_var_entity: Option<CreateExportCustomJobError> =
            serde_json::from_str(&local_var_content).ok();
...
pub async fn delete_job(
...
) -> Result<ResponseContent<DeleteJobSuccess>, Error<DeleteJobError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        JobSid = crate::apis::urlencode(job_sid)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteJobSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_day(
    configuration: &configuration::Configuration,
    params: FetchDayParams,
) -> Result<ResponseContent<FetchDaySuccess>, Error<FetchDayError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchDaySuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_export(
    configuration: &configuration::Configuration,
    params: FetchExportParams,
) -> Result<ResponseContent<FetchExportSuccess>, Error<FetchExportError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchExportSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchExportError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_export_configuration(
    configuration: &configuration::Configuration,
    params: FetchExportConfigurationParams,
) -> Result<ResponseContent<FetchExportConfigurationSuccess>, Error<FetchExportConfigurationError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchExportConfigurationSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchExportConfigurationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_job(
...
) -> Result<ResponseContent<FetchJobSuccess>, Error<FetchJobError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchJobSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_day(
...
) -> Result<ResponseContent<ListDaySuccess>, Error<ListDayError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListDaySuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn list_export_custom_job(
    configuration: &configuration::Configuration,
    params: ListExportCustomJobParams,
) -> Result<ResponseContent<ListExportCustomJobSuccess>, Error<ListExportCustomJobError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListExportCustomJobSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListExportCustomJobError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_export_configuration(
    configuration: &configuration::Configuration,
    params: UpdateExportConfigurationParams,
) -> Result<ResponseContent<UpdateExportConfigurationSuccess>, Error<UpdateExportConfigurationError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateExportConfigurationSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<UpdateExportConfigurationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
