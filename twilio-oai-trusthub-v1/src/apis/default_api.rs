...
pub async fn create_customer_profile(
...
) -> Result<ResponseContent<CreateCustomerProfileSuccess>, Error<CreateCustomerProfileError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateCustomerProfileSuccess> =
        ...
        let local_var_entity: Option<CreateCustomerProfileError> =
            serde_json::from_str(&local_var_content).ok();
...
pub async fn create_customer_profile_channel_endpoint_assignment(
    configuration: &configuration::Configuration,
    params: CreateCustomerProfileChannelEndpointAssignmentParams,
) -> Result<
    ResponseContent<CreateCustomerProfileChannelEndpointAssignmentSuccess>,
...
> {
    ...
    let local_var_uri_str = format!(
        ...
        CustomerProfileSid = crate::apis::urlencode(customer_profile_sid)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateCustomerProfileChannelEndpointAssignmentSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateCustomerProfileChannelEndpointAssignmentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Create a new Assigned Item.
pub async fn create_customer_profile_entity_assignment(
    configuration: &configuration::Configuration,
    params: CreateCustomerProfileEntityAssignmentParams,
) -> Result<
    ResponseContent<CreateCustomerProfileEntityAssignmentSuccess>,
    Error<CreateCustomerProfileEntityAssignmentError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateCustomerProfileEntityAssignmentSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateCustomerProfileEntityAssignmentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_customer_profile_evaluation(
    configuration: &configuration::Configuration,
    params: CreateCustomerProfileEvaluationParams,
) -> Result<
    ResponseContent<CreateCustomerProfileEvaluationSuccess>,
    Error<CreateCustomerProfileEvaluationError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateCustomerProfileEvaluationSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateCustomerProfileEvaluationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_end_user(
...
) -> Result<ResponseContent<CreateEndUserSuccess>, Error<CreateEndUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateEndUserSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateEndUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_supporting_document(
    configuration: &configuration::Configuration,
    params: CreateSupportingDocumentParams,
) -> Result<ResponseContent<CreateSupportingDocumentSuccess>, Error<CreateSupportingDocumentError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateSupportingDocumentSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateSupportingDocumentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Create a new Customer-Profile.
pub async fn create_trust_product(
    configuration: &configuration::Configuration,
    params: CreateTrustProductParams,
) -> Result<ResponseContent<CreateTrustProductSuccess>, Error<CreateTrustProductError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateTrustProductSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateTrustProductError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Create a new Assigned Item.
pub async fn create_trust_product_channel_endpoint_assignment(
    configuration: &configuration::Configuration,
    params: CreateTrustProductChannelEndpointAssignmentParams,
) -> Result<
    ResponseContent<CreateTrustProductChannelEndpointAssignmentSuccess>,
    Error<CreateTrustProductChannelEndpointAssignmentError>,
> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        TrustProductSid = crate::apis::urlencode(trust_product_sid)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateTrustProductChannelEndpointAssignmentSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateTrustProductChannelEndpointAssignmentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Create a new Assigned Item.
pub async fn create_trust_product_entity_assignment(
    configuration: &configuration::Configuration,
    params: CreateTrustProductEntityAssignmentParams,
) -> Result<
    ResponseContent<CreateTrustProductEntityAssignmentSuccess>,
    Error<CreateTrustProductEntityAssignmentError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateTrustProductEntityAssignmentSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateTrustProductEntityAssignmentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Create a new Evaluation
pub async fn create_trust_product_evaluation(
    configuration: &configuration::Configuration,
    params: CreateTrustProductEvaluationParams,
) -> Result<
    ResponseContent<CreateTrustProductEvaluationSuccess>,
    Error<CreateTrustProductEvaluationError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateTrustProductEvaluationSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateTrustProductEvaluationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_customer_profile(
...
) -> Result<ResponseContent<DeleteCustomerProfileSuccess>, Error<DeleteCustomerProfileError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteCustomerProfileSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteCustomerProfileError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_customer_profile_channel_endpoint_assignment(
    configuration: &configuration::Configuration,
    params: DeleteCustomerProfileChannelEndpointAssignmentParams,
) -> Result<
    ResponseContent<DeleteCustomerProfileChannelEndpointAssignmentSuccess>,
    Error<DeleteCustomerProfileChannelEndpointAssignmentError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteCustomerProfileChannelEndpointAssignmentSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteCustomerProfileChannelEndpointAssignmentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Remove an Assignment Item Instance.
pub async fn delete_customer_profile_entity_assignment(
    configuration: &configuration::Configuration,
    params: DeleteCustomerProfileEntityAssignmentParams,
) -> Result<
    ResponseContent<DeleteCustomerProfileEntityAssignmentSuccess>,
    Error<DeleteCustomerProfileEntityAssignmentError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteCustomerProfileEntityAssignmentSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteCustomerProfileEntityAssignmentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_end_user(
    configuration: &configuration::Configuration,
    params: DeleteEndUserParams,
) -> Result<ResponseContent<DeleteEndUserSuccess>, Error<DeleteEndUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteEndUserSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteEndUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_supporting_document(
    configuration: &configuration::Configuration,
    params: DeleteSupportingDocumentParams,
) -> Result<ResponseContent<DeleteSupportingDocumentSuccess>, Error<DeleteSupportingDocumentError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteSupportingDocumentSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteSupportingDocumentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Delete a specific Customer-Profile.
pub async fn delete_trust_product(
    configuration: &configuration::Configuration,
    params: DeleteTrustProductParams,
) -> Result<ResponseContent<DeleteTrustProductSuccess>, Error<DeleteTrustProductError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteTrustProductSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteTrustProductError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Remove an Assignment Item Instance.
pub async fn delete_trust_product_channel_endpoint_assignment(
    configuration: &configuration::Configuration,
    params: DeleteTrustProductChannelEndpointAssignmentParams,
) -> Result<
    ResponseContent<DeleteTrustProductChannelEndpointAssignmentSuccess>,
    Error<DeleteTrustProductChannelEndpointAssignmentError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteTrustProductChannelEndpointAssignmentSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteTrustProductChannelEndpointAssignmentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Remove an Assignment Item Instance.
pub async fn delete_trust_product_entity_assignment(
    configuration: &configuration::Configuration,
    params: DeleteTrustProductEntityAssignmentParams,
) -> Result<
    ResponseContent<DeleteTrustProductEntityAssignmentSuccess>,
    Error<DeleteTrustProductEntityAssignmentError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteTrustProductEntityAssignmentSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteTrustProductEntityAssignmentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_customer_profile(
    configuration: &configuration::Configuration,
    params: FetchCustomerProfileParams,
) -> Result<ResponseContent<FetchCustomerProfileSuccess>, Error<FetchCustomerProfileError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchCustomerProfileSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchCustomerProfileError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_customer_profile_channel_endpoint_assignment(
    configuration: &configuration::Configuration,
    params: FetchCustomerProfileChannelEndpointAssignmentParams,
) -> Result<
    ResponseContent<FetchCustomerProfileChannelEndpointAssignmentSuccess>,
    Error<FetchCustomerProfileChannelEndpointAssignmentError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchCustomerProfileChannelEndpointAssignmentSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchCustomerProfileChannelEndpointAssignmentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Fetch specific Assigned Item Instance.
pub async fn fetch_customer_profile_entity_assignment(
    configuration: &configuration::Configuration,
    params: FetchCustomerProfileEntityAssignmentParams,
) -> Result<
    ResponseContent<FetchCustomerProfileEntityAssignmentSuccess>,
    Error<FetchCustomerProfileEntityAssignmentError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchCustomerProfileEntityAssignmentSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchCustomerProfileEntityAssignmentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_customer_profile_evaluation(
    configuration: &configuration::Configuration,
    params: FetchCustomerProfileEvaluationParams,
) -> Result<
    ResponseContent<FetchCustomerProfileEvaluationSuccess>,
    Error<FetchCustomerProfileEvaluationError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchCustomerProfileEvaluationSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchCustomerProfileEvaluationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_end_user(
    configuration: &configuration::Configuration,
    params: FetchEndUserParams,
) -> Result<ResponseContent<FetchEndUserSuccess>, Error<FetchEndUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchEndUserSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchEndUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_end_user_type(
    configuration: &configuration::Configuration,
    params: FetchEndUserTypeParams,
) -> Result<ResponseContent<FetchEndUserTypeSuccess>, Error<FetchEndUserTypeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchEndUserTypeSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchEndUserTypeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_policies(
...
) -> Result<ResponseContent<FetchPoliciesSuccess>, Error<FetchPoliciesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchPoliciesSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchPoliciesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_supporting_document(
    configuration: &configuration::Configuration,
    params: FetchSupportingDocumentParams,
) -> Result<ResponseContent<FetchSupportingDocumentSuccess>, Error<FetchSupportingDocumentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchSupportingDocumentSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchSupportingDocumentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_supporting_document_type(
    configuration: &configuration::Configuration,
    params: FetchSupportingDocumentTypeParams,
) -> Result<
    ResponseContent<FetchSupportingDocumentTypeSuccess>,
    Error<FetchSupportingDocumentTypeError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchSupportingDocumentTypeSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchSupportingDocumentTypeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Fetch a specific Customer-Profile instance.
pub async fn fetch_trust_product(
    configuration: &configuration::Configuration,
    params: FetchTrustProductParams,
) -> Result<ResponseContent<FetchTrustProductSuccess>, Error<FetchTrustProductError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchTrustProductSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchTrustProductError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Fetch specific Assigned Item Instance.
pub async fn fetch_trust_product_channel_endpoint_assignment(
    configuration: &configuration::Configuration,
    params: FetchTrustProductChannelEndpointAssignmentParams,
) -> Result<
    ResponseContent<FetchTrustProductChannelEndpointAssignmentSuccess>,
    Error<FetchTrustProductChannelEndpointAssignmentError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchTrustProductChannelEndpointAssignmentSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchTrustProductChannelEndpointAssignmentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Fetch specific Assigned Item Instance.
pub async fn fetch_trust_product_entity_assignment(
    configuration: &configuration::Configuration,
    params: FetchTrustProductEntityAssignmentParams,
) -> Result<
    ResponseContent<FetchTrustProductEntityAssignmentSuccess>,
    Error<FetchTrustProductEntityAssignmentError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchTrustProductEntityAssignmentSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchTrustProductEntityAssignmentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Fetch specific Evaluation Instance.
pub async fn fetch_trust_product_evaluation(
    configuration: &configuration::Configuration,
    params: FetchTrustProductEvaluationParams,
) -> Result<
    ResponseContent<FetchTrustProductEvaluationSuccess>,
    Error<FetchTrustProductEvaluationError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchTrustProductEvaluationSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchTrustProductEvaluationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_customer_profile(
    configuration: &configuration::Configuration,
    params: ListCustomerProfileParams,
) -> Result<ResponseContent<ListCustomerProfileSuccess>, Error<ListCustomerProfileError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = policy_sid {
        local_var_req_builder =
            local_var_req_builder.query(&[("PolicySid", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListCustomerProfileSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListCustomerProfileError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_customer_profile_channel_endpoint_assignment(
    configuration: &configuration::Configuration,
    params: ListCustomerProfileChannelEndpointAssignmentParams,
) -> Result<
    ResponseContent<ListCustomerProfileChannelEndpointAssignmentSuccess>,
    Error<ListCustomerProfileChannelEndpointAssignmentError>,
> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = channel_endpoint_sid {
        local_var_req_builder =
            local_var_req_builder.query(&[("ChannelEndpointSid", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = channel_endpoint_sids {
        local_var_req_builder =
            local_var_req_builder.query(&[("ChannelEndpointSids", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = page_size {
        local_var_req_builder =
            local_var_req_builder.query(&[("PageSize", &local_var_str.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListCustomerProfileChannelEndpointAssignmentSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListCustomerProfileChannelEndpointAssignmentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Retrieve a list of all Assigned Items for an account.
pub async fn list_customer_profile_entity_assignment(
    configuration: &configuration::Configuration,
    params: ListCustomerProfileEntityAssignmentParams,
) -> Result<
    ResponseContent<ListCustomerProfileEntityAssignmentSuccess>,
    Error<ListCustomerProfileEntityAssignmentError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListCustomerProfileEntityAssignmentSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListCustomerProfileEntityAssignmentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_customer_profile_evaluation(
    configuration: &configuration::Configuration,
    params: ListCustomerProfileEvaluationParams,
) -> Result<
    ResponseContent<ListCustomerProfileEvaluationSuccess>,
    Error<ListCustomerProfileEvaluationError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListCustomerProfileEvaluationSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListCustomerProfileEvaluationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_end_user(
    configuration: &configuration::Configuration,
    params: ListEndUserParams,
) -> Result<ResponseContent<ListEndUserSuccess>, Error<ListEndUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListEndUserSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListEndUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_end_user_type(
    configuration: &configuration::Configuration,
    params: ListEndUserTypeParams,
) -> Result<ResponseContent<ListEndUserTypeSuccess>, Error<ListEndUserTypeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListEndUserTypeSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListEndUserTypeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_policies(
...
) -> Result<ResponseContent<ListPoliciesSuccess>, Error<ListPoliciesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListPoliciesSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_supporting_document(
    configuration: &configuration::Configuration,
    params: ListSupportingDocumentParams,
) -> Result<ResponseContent<ListSupportingDocumentSuccess>, Error<ListSupportingDocumentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListSupportingDocumentSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListSupportingDocumentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_supporting_document_type(
    configuration: &configuration::Configuration,
    params: ListSupportingDocumentTypeParams,
) -> Result<
    ResponseContent<ListSupportingDocumentTypeSuccess>,
    Error<ListSupportingDocumentTypeError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListSupportingDocumentTypeSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListSupportingDocumentTypeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Retrieve a list of all Customer-Profiles for an account.
pub async fn list_trust_product(
    configuration: &configuration::Configuration,
    params: ListTrustProductParams,
) -> Result<ResponseContent<ListTrustProductSuccess>, Error<ListTrustProductError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListTrustProductSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListTrustProductError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Retrieve a list of all Assigned Items for an account.
pub async fn list_trust_product_channel_endpoint_assignment(
    configuration: &configuration::Configuration,
    params: ListTrustProductChannelEndpointAssignmentParams,
) -> Result<
    ResponseContent<ListTrustProductChannelEndpointAssignmentSuccess>,
    Error<ListTrustProductChannelEndpointAssignmentError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListTrustProductChannelEndpointAssignmentSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListTrustProductChannelEndpointAssignmentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Retrieve a list of all Assigned Items for an account.
pub async fn list_trust_product_entity_assignment(
    configuration: &configuration::Configuration,
    params: ListTrustProductEntityAssignmentParams,
) -> Result<
    ResponseContent<ListTrustProductEntityAssignmentSuccess>,
    Error<ListTrustProductEntityAssignmentError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListTrustProductEntityAssignmentSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListTrustProductEntityAssignmentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_trust_product_evaluation(
    configuration: &configuration::Configuration,
    params: ListTrustProductEvaluationParams,
) -> Result<
    ResponseContent<ListTrustProductEvaluationSuccess>,
    Error<ListTrustProductEvaluationError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListTrustProductEvaluationSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListTrustProductEvaluationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_customer_profile(
...
) -> Result<ResponseContent<UpdateCustomerProfileSuccess>, Error<UpdateCustomerProfileError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateCustomerProfileSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<UpdateCustomerProfileError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_end_user(
...
) -> Result<ResponseContent<UpdateEndUserSuccess>, Error<UpdateEndUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateEndUserSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<UpdateEndUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_supporting_document(
    configuration: &configuration::Configuration,
    params: UpdateSupportingDocumentParams,
) -> Result<ResponseContent<UpdateSupportingDocumentSuccess>, Error<UpdateSupportingDocumentError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateSupportingDocumentSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<UpdateSupportingDocumentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Updates a Customer-Profile in an account.
pub async fn update_trust_product(
    configuration: &configuration::Configuration,
    params: UpdateTrustProductParams,
) -> Result<ResponseContent<UpdateTrustProductSuccess>, Error<UpdateTrustProductError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateTrustProductSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<UpdateTrustProductError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
