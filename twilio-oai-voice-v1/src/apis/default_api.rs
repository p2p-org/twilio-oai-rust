...
/// struct for passing parameters to the method [`delete_archived_call`]
#[derive(Clone, Debug, Default)]
pub struct DeleteArchivedCallParams {
...
/// struct for typed successes of method [`delete_archived_call`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteArchivedCallSuccess {
    Status204(),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`delete_archived_call`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteArchivedCallError {
    UnknownValue(serde_json::Value),
}
...
///
pub async fn create_byoc_trunk(
    configuration: &configuration::Configuration,
    params: CreateByocTrunkParams,
) -> Result<ResponseContent<CreateByocTrunkSuccess>, Error<CreateByocTrunkError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateByocTrunkSuccess> =
        ...
        let local_var_entity: Option<CreateByocTrunkError> =
            serde_json::from_str(&local_var_content).ok();
...
///
pub async fn create_connection_policy(
    configuration: &configuration::Configuration,
    params: CreateConnectionPolicyParams,
) -> Result<ResponseContent<CreateConnectionPolicySuccess>, Error<CreateConnectionPolicyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateConnectionPolicySuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateConnectionPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn create_connection_policy_target(
    configuration: &configuration::Configuration,
    params: CreateConnectionPolicyTargetParams,
) -> Result<
    ResponseContent<CreateConnectionPolicyTargetSuccess>,
    Error<CreateConnectionPolicyTargetError>,
> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        ConnectionPolicySid = crate::apis::urlencode(connection_policy_sid)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateConnectionPolicyTargetSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateConnectionPolicyTargetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_dialing_permissions_country_bulk_update(
    configuration: &configuration::Configuration,
    params: CreateDialingPermissionsCountryBulkUpdateParams,
) -> Result<
    ResponseContent<CreateDialingPermissionsCountryBulkUpdateSuccess>,
    Error<CreateDialingPermissionsCountryBulkUpdateError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateDialingPermissionsCountryBulkUpdateSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateDialingPermissionsCountryBulkUpdateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn create_ip_record(
    configuration: &configuration::Configuration,
    params: CreateIpRecordParams,
) -> Result<ResponseContent<CreateIpRecordSuccess>, Error<CreateIpRecordError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateIpRecordSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateIpRecordError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn create_source_ip_mapping(
    configuration: &configuration::Configuration,
    params: CreateSourceIpMappingParams,
) -> Result<ResponseContent<CreateSourceIpMappingSuccess>, Error<CreateSourceIpMappingError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateSourceIpMappingSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateSourceIpMappingError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_archived_call(
    configuration: &configuration::Configuration,
    params: DeleteArchivedCallParams,
) -> Result<ResponseContent<DeleteArchivedCallSuccess>, Error<DeleteArchivedCallError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteArchivedCallSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteArchivedCallError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn delete_byoc_trunk(
    configuration: &configuration::Configuration,
    params: DeleteByocTrunkParams,
) -> Result<ResponseContent<DeleteByocTrunkSuccess>, Error<DeleteByocTrunkError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteByocTrunkSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteByocTrunkError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn delete_connection_policy(
    configuration: &configuration::Configuration,
    params: DeleteConnectionPolicyParams,
) -> Result<ResponseContent<DeleteConnectionPolicySuccess>, Error<DeleteConnectionPolicyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteConnectionPolicySuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteConnectionPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn delete_connection_policy_target(
    configuration: &configuration::Configuration,
    params: DeleteConnectionPolicyTargetParams,
) -> Result<
    ResponseContent<DeleteConnectionPolicyTargetSuccess>,
    Error<DeleteConnectionPolicyTargetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteConnectionPolicyTargetSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteConnectionPolicyTargetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_ip_record(
    configuration: &configuration::Configuration,
    params: DeleteIpRecordParams,
) -> Result<ResponseContent<DeleteIpRecordSuccess>, Error<DeleteIpRecordError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteIpRecordSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteIpRecordError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn delete_source_ip_mapping(
    configuration: &configuration::Configuration,
    params: DeleteSourceIpMappingParams,
) -> Result<ResponseContent<DeleteSourceIpMappingSuccess>, Error<DeleteSourceIpMappingError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteSourceIpMappingSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteSourceIpMappingError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn fetch_byoc_trunk(
    configuration: &configuration::Configuration,
    params: FetchByocTrunkParams,
) -> Result<ResponseContent<FetchByocTrunkSuccess>, Error<FetchByocTrunkError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchByocTrunkSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchByocTrunkError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn fetch_connection_policy(
    configuration: &configuration::Configuration,
    params: FetchConnectionPolicyParams,
) -> Result<ResponseContent<FetchConnectionPolicySuccess>, Error<FetchConnectionPolicyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchConnectionPolicySuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchConnectionPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn fetch_connection_policy_target(
    configuration: &configuration::Configuration,
    params: FetchConnectionPolicyTargetParams,
) -> Result<
    ResponseContent<FetchConnectionPolicyTargetSuccess>,
    Error<FetchConnectionPolicyTargetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchConnectionPolicyTargetSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchConnectionPolicyTargetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_dialing_permissions_country(
    configuration: &configuration::Configuration,
    params: FetchDialingPermissionsCountryParams,
) -> Result<
    ResponseContent<FetchDialingPermissionsCountrySuccess>,
    Error<FetchDialingPermissionsCountryError>,
> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        IsoCode = crate::apis::urlencode(iso_code)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchDialingPermissionsCountrySuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchDialingPermissionsCountryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_dialing_permissions_settings(
    configuration: &configuration::Configuration,
) -> Result<
    ResponseContent<FetchDialingPermissionsSettingsSuccess>,
    Error<FetchDialingPermissionsSettingsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchDialingPermissionsSettingsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchDialingPermissionsSettingsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_ip_record(
    configuration: &configuration::Configuration,
    params: FetchIpRecordParams,
) -> Result<ResponseContent<FetchIpRecordSuccess>, Error<FetchIpRecordError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchIpRecordSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchIpRecordError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn fetch_source_ip_mapping(
    configuration: &configuration::Configuration,
    params: FetchSourceIpMappingParams,
) -> Result<ResponseContent<FetchSourceIpMappingSuccess>, Error<FetchSourceIpMappingError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchSourceIpMappingSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchSourceIpMappingError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn list_byoc_trunk(
    configuration: &configuration::Configuration,
    params: ListByocTrunkParams,
) -> Result<ResponseContent<ListByocTrunkSuccess>, Error<ListByocTrunkError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListByocTrunkSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListByocTrunkError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn list_connection_policy(
    configuration: &configuration::Configuration,
    params: ListConnectionPolicyParams,
) -> Result<ResponseContent<ListConnectionPolicySuccess>, Error<ListConnectionPolicyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListConnectionPolicySuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListConnectionPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn list_connection_policy_target(
    configuration: &configuration::Configuration,
    params: ListConnectionPolicyTargetParams,
) -> Result<
    ResponseContent<ListConnectionPolicyTargetSuccess>,
    Error<ListConnectionPolicyTargetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListConnectionPolicyTargetSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListConnectionPolicyTargetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_dialing_permissions_country(
    configuration: &configuration::Configuration,
    params: ListDialingPermissionsCountryParams,
) -> Result<
    ResponseContent<ListDialingPermissionsCountrySuccess>,
    Error<ListDialingPermissionsCountryError>,
> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = iso_code {
        local_var_req_builder =
            local_var_req_builder.query(&[("IsoCode", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = continent {
        local_var_req_builder =
            local_var_req_builder.query(&[("Continent", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = low_risk_numbers_enabled {
        local_var_req_builder =
            local_var_req_builder.query(&[("LowRiskNumbersEnabled", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = high_risk_special_numbers_enabled {
        local_var_req_builder = local_var_req_builder
            .query(&[("HighRiskSpecialNumbersEnabled", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListDialingPermissionsCountrySuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListDialingPermissionsCountryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_dialing_permissions_hrs_prefixes(
    configuration: &configuration::Configuration,
    params: ListDialingPermissionsHrsPrefixesParams,
) -> Result<
    ResponseContent<ListDialingPermissionsHrsPrefixesSuccess>,
    Error<ListDialingPermissionsHrsPrefixesError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListDialingPermissionsHrsPrefixesSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListDialingPermissionsHrsPrefixesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn list_ip_record(
    configuration: &configuration::Configuration,
    params: ListIpRecordParams,
) -> Result<ResponseContent<ListIpRecordSuccess>, Error<ListIpRecordError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListIpRecordSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListIpRecordError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn list_source_ip_mapping(
    configuration: &configuration::Configuration,
    params: ListSourceIpMappingParams,
) -> Result<ResponseContent<ListSourceIpMappingSuccess>, Error<ListSourceIpMappingError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListSourceIpMappingSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListSourceIpMappingError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn update_byoc_trunk(
    configuration: &configuration::Configuration,
    params: UpdateByocTrunkParams,
) -> Result<ResponseContent<UpdateByocTrunkSuccess>, Error<UpdateByocTrunkError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateByocTrunkSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<UpdateByocTrunkError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_connection_policy(
...
) -> Result<ResponseContent<UpdateConnectionPolicySuccess>, Error<UpdateConnectionPolicyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateConnectionPolicySuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<UpdateConnectionPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn update_connection_policy_target(
    configuration: &configuration::Configuration,
    params: UpdateConnectionPolicyTargetParams,
) -> Result<
    ResponseContent<UpdateConnectionPolicyTargetSuccess>,
    Error<UpdateConnectionPolicyTargetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateConnectionPolicyTargetSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<UpdateConnectionPolicyTargetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_dialing_permissions_settings(
    configuration: &configuration::Configuration,
    params: UpdateDialingPermissionsSettingsParams,
) -> Result<
    ResponseContent<UpdateDialingPermissionsSettingsSuccess>,
    Error<UpdateDialingPermissionsSettingsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateDialingPermissionsSettingsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<UpdateDialingPermissionsSettingsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn update_ip_record(
    configuration: &configuration::Configuration,
    params: UpdateIpRecordParams,
) -> Result<ResponseContent<UpdateIpRecordSuccess>, Error<UpdateIpRecordError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateIpRecordSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<UpdateIpRecordError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn update_source_ip_mapping(
    configuration: &configuration::Configuration,
    params: UpdateSourceIpMappingParams,
) -> Result<ResponseContent<UpdateSourceIpMappingSuccess>, Error<UpdateSourceIpMappingError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateSourceIpMappingSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<UpdateSourceIpMappingError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
