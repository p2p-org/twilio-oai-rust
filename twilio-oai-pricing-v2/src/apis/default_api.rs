...
pub async fn fetch_trunking_country(
    configuration: &configuration::Configuration,
    params: FetchTrunkingCountryParams,
) -> Result<ResponseContent<FetchTrunkingCountrySuccess>, Error<FetchTrunkingCountryError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchTrunkingCountrySuccess> =
        ...
        let local_var_entity: Option<FetchTrunkingCountryError> =
            serde_json::from_str(&local_var_content).ok();
...
pub async fn fetch_trunking_number(
    configuration: &configuration::Configuration,
    params: FetchTrunkingNumberParams,
) -> Result<ResponseContent<FetchTrunkingNumberSuccess>, Error<FetchTrunkingNumberError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        DestinationNumber = crate::apis::urlencode(destination_number)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if let Some(ref local_var_str) = origination_number {
        local_var_req_builder =
            local_var_req_builder.query(&[("OriginationNumber", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchTrunkingNumberSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchTrunkingNumberError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn list_trunking_country(
    configuration: &configuration::Configuration,
    params: ListTrunkingCountryParams,
) -> Result<ResponseContent<ListTrunkingCountrySuccess>, Error<ListTrunkingCountryError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListTrunkingCountrySuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListTrunkingCountryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
