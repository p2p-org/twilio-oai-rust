...
pub struct PricingV2VoiceVoiceNumberOutboundCallPricesInner {
...
impl PricingV2VoiceVoiceNumberOutboundCallPricesInner {
    pub fn new() -> PricingV2VoiceVoiceNumberOutboundCallPricesInner {
