...
pub struct TrunkingV1Trunk {
    ...
    #[serde(rename = "transfer_caller_id", skip_serializing_if = "Option::is_none")]
    pub transfer_caller_id: Option<TransferCallerId>,
...
impl Default for DisasterRecoveryMethod {
    fn default() -> DisasterRecoveryMethod {
        Self::HEAD
    }
}
/// Caller Id for transfer target
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum TransferCallerId {
    #[serde(rename = "from-transferee")]
    Transferee,
    #[serde(rename = "from-transferor")]
    Transferor,
}

impl Default for TransferCallerId {
    fn default() -> TransferCallerId {
        Self::Transferee
    }
}
/// The call transfer settings for the trunk
