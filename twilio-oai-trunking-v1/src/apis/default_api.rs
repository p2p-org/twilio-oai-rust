...
pub struct CreateTrunkParams {
    ...
    pub transfer_caller_id: Option<String>,
...
pub async fn create_credential_list(
...
) -> Result<ResponseContent<CreateCredentialListSuccess>, Error<CreateCredentialListError>> {
    ...
    let local_var_uri_str = format!(
        ...
        TrunkSid = crate::apis::urlencode(trunk_sid)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateCredentialListSuccess> =
        ...
        let local_var_entity: Option<CreateCredentialListError> =
            serde_json::from_str(&local_var_content).ok();
...
pub async fn create_ip_access_control_list(
    configuration: &configuration::Configuration,
    params: CreateIpAccessControlListParams,
) -> Result<ResponseContent<CreateIpAccessControlListSuccess>, Error<CreateIpAccessControlListError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateIpAccessControlListSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateIpAccessControlListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn create_origination_url(
    configuration: &configuration::Configuration,
    params: CreateOriginationUrlParams,
) -> Result<ResponseContent<CreateOriginationUrlSuccess>, Error<CreateOriginationUrlError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateOriginationUrlSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateOriginationUrlError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_trunk(
...
) -> Result<ResponseContent<CreateTrunkSuccess>, Error<CreateTrunkError>> {
    let local_var_configuration = configuration;
    ...
    let transfer_caller_id = params.transfer_caller_id;
    ...
    if let Some(local_var_param_value) = transfer_caller_id {
        local_var_form_params.insert("TransferCallerId", local_var_param_value.to_string());
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateTrunkSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateTrunkError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn delete_credential_list(
    configuration: &configuration::Configuration,
    params: DeleteCredentialListParams,
) -> Result<ResponseContent<DeleteCredentialListSuccess>, Error<DeleteCredentialListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteCredentialListSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteCredentialListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_ip_access_control_list(
    configuration: &configuration::Configuration,
    params: DeleteIpAccessControlListParams,
) -> Result<ResponseContent<DeleteIpAccessControlListSuccess>, Error<DeleteIpAccessControlListError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteIpAccessControlListSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteIpAccessControlListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn delete_origination_url(
    configuration: &configuration::Configuration,
    params: DeleteOriginationUrlParams,
) -> Result<ResponseContent<DeleteOriginationUrlSuccess>, Error<DeleteOriginationUrlError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteOriginationUrlSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteOriginationUrlError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_trunk(
    configuration: &configuration::Configuration,
    params: DeleteTrunkParams,
) -> Result<ResponseContent<DeleteTrunkSuccess>, Error<DeleteTrunkError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteTrunkSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteTrunkError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn fetch_credential_list(
    configuration: &configuration::Configuration,
    params: FetchCredentialListParams,
) -> Result<ResponseContent<FetchCredentialListSuccess>, Error<FetchCredentialListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchCredentialListSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchCredentialListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn fetch_ip_access_control_list(
    configuration: &configuration::Configuration,
    params: FetchIpAccessControlListParams,
) -> Result<ResponseContent<FetchIpAccessControlListSuccess>, Error<FetchIpAccessControlListError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchIpAccessControlListSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchIpAccessControlListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn fetch_origination_url(
    configuration: &configuration::Configuration,
    params: FetchOriginationUrlParams,
) -> Result<ResponseContent<FetchOriginationUrlSuccess>, Error<FetchOriginationUrlError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchOriginationUrlSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchOriginationUrlError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn fetch_trunk(
    configuration: &configuration::Configuration,
    params: FetchTrunkParams,
) -> Result<ResponseContent<FetchTrunkSuccess>, Error<FetchTrunkError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchTrunkSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchTrunkError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn list_credential_list(
    configuration: &configuration::Configuration,
    params: ListCredentialListParams,
) -> Result<ResponseContent<ListCredentialListSuccess>, Error<ListCredentialListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListCredentialListSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListCredentialListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_ip_access_control_list(
    configuration: &configuration::Configuration,
    params: ListIpAccessControlListParams,
) -> Result<ResponseContent<ListIpAccessControlListSuccess>, Error<ListIpAccessControlListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListIpAccessControlListSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListIpAccessControlListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn list_origination_url(
    configuration: &configuration::Configuration,
    params: ListOriginationUrlParams,
) -> Result<ResponseContent<ListOriginationUrlSuccess>, Error<ListOriginationUrlError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListOriginationUrlSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListOriginationUrlError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn list_trunk(
    configuration: &configuration::Configuration,
    params: ListTrunkParams,
) -> Result<ResponseContent<ListTrunkSuccess>, Error<ListTrunkError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListTrunkSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListTrunkError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn update_origination_url(
    configuration: &configuration::Configuration,
    params: UpdateOriginationUrlParams,
) -> Result<ResponseContent<UpdateOriginationUrlSuccess>, Error<UpdateOriginationUrlError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateOriginationUrlSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<UpdateOriginationUrlError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_recording(
...
) -> Result<ResponseContent<UpdateRecordingSuccess>, Error<UpdateRecordingError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateRecordingSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<UpdateRecordingError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_trunk(
...
) -> Result<ResponseContent<UpdateTrunkSuccess>, Error<UpdateTrunkError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateTrunkSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<UpdateTrunkError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
