...
/// struct for typed successes of method [`create_brand_vetting`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateBrandVettingSuccess {
    Status201(crate::models::MessagingV1BrandRegistrationsBrandVetting),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed successes of method [`fetch_brand_vetting`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum FetchBrandVettingSuccess {
    Status200(crate::models::MessagingV1BrandRegistrationsBrandVetting),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed successes of method [`list_brand_vetting`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListBrandVettingSuccess {
    Status200(crate::models::ListBrandVettingResponse),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed successes of method [`update_brand_registrations`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UpdateBrandRegistrationsSuccess {
    Status202(crate::models::MessagingV1BrandRegistrations),
    UnknownValue(serde_json::Value),
}
...
pub async fn create_alpha_sender(
...
) -> Result<ResponseContent<CreateAlphaSenderSuccess>, Error<CreateAlphaSenderError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateAlphaSenderSuccess> =
        ...
        let local_var_entity: Option<CreateAlphaSenderError> =
            serde_json::from_str(&local_var_content).ok();
...
) -> Result<ResponseContent<CreateBrandRegistrationsSuccess>, Error<CreateBrandRegistrationsError>>
{
    let local_var_configuration = configuration;

    // unbox the parameters
    let a2_p_profile_bundle_sid = params.a2_p_profile_bundle_sid;
    ...
    let mut local_var_form_params = std::collections::HashMap::new();
    local_var_form_params.insert("A2PProfileBundleSid", a2_p_profile_bundle_sid.to_string());
    ...
    local_var_form_params.insert(
        ...
        customer_profile_bundle_sid.to_string(),
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateBrandRegistrationsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateBrandRegistrationsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_brand_vetting(
...
) -> Result<ResponseContent<CreateBrandVettingSuccess>, Error<CreateBrandVettingError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let brand_sid = params.brand_sid;
    let vetting_provider = params.vetting_provider;
    let vetting_id = params.vetting_id;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        BrandSid = crate::apis::urlencode(brand_sid)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    let mut local_var_form_params = std::collections::HashMap::new();
    if let Some(local_var_param_value) = vetting_id {
        local_var_form_params.insert("VettingId", local_var_param_value.to_string());
    }
    local_var_form_params.insert("VettingProvider", vetting_provider.to_string());
    local_var_req_builder = local_var_req_builder.form(&local_var_form_params);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateBrandVettingSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateBrandVettingError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_external_campaign(
...
) -> Result<ResponseContent<CreateExternalCampaignSuccess>, Error<CreateExternalCampaignError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateExternalCampaignSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateExternalCampaignError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_phone_number(
...
) -> Result<ResponseContent<CreatePhoneNumberSuccess>, Error<CreatePhoneNumberError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreatePhoneNumberSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_service(
    ...
    if let Some(local_var_param_value) = usecase {
        local_var_form_params.insert("Usecase", local_var_param_value.to_string());
    }
...
pub async fn create_short_code(
...
) -> Result<ResponseContent<CreateShortCodeSuccess>, Error<CreateShortCodeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateShortCodeSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateShortCodeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_us_app_to_person(
...
) -> Result<ResponseContent<CreateUsAppToPersonSuccess>, Error<CreateUsAppToPersonError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        MessagingServiceSid = crate::apis::urlencode(messaging_service_sid)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateUsAppToPersonSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateUsAppToPersonError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_alpha_sender(
...
) -> Result<ResponseContent<DeleteAlphaSenderSuccess>, Error<DeleteAlphaSenderError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteAlphaSenderSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteAlphaSenderError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_phone_number(
...
) -> Result<ResponseContent<DeletePhoneNumberSuccess>, Error<DeletePhoneNumberError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeletePhoneNumberSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_short_code(
...
) -> Result<ResponseContent<DeleteShortCodeSuccess>, Error<DeleteShortCodeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteShortCodeSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteShortCodeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_us_app_to_person(
...
) -> Result<ResponseContent<DeleteUsAppToPersonSuccess>, Error<DeleteUsAppToPersonError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteUsAppToPersonSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteUsAppToPersonError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_alpha_sender(
...
) -> Result<ResponseContent<FetchAlphaSenderSuccess>, Error<FetchAlphaSenderError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchAlphaSenderSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchAlphaSenderError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_brand_registrations(
...
) -> Result<ResponseContent<FetchBrandRegistrationsSuccess>, Error<FetchBrandRegistrationsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchBrandRegistrationsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchBrandRegistrationsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_brand_vetting(
...
) -> Result<ResponseContent<FetchBrandVettingSuccess>, Error<FetchBrandVettingError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let brand_sid = params.brand_sid;
    let brand_vetting_sid = params.brand_vetting_sid;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        BrandSid = crate::apis::urlencode(brand_sid),
        BrandVettingSid = crate::apis::urlencode(brand_vetting_sid)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchBrandVettingSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchBrandVettingError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_deactivation(
...
) -> Result<ResponseContent<FetchDeactivationSuccess>, Error<FetchDeactivationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchDeactivationSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchDeactivationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_short_code(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchShortCodeSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_us_app_to_person(
...
) -> Result<ResponseContent<FetchUsAppToPersonSuccess>, Error<FetchUsAppToPersonError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchUsAppToPersonSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchUsAppToPersonError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<ResponseContent<FetchUsAppToPersonUsecaseSuccess>, Error<FetchUsAppToPersonUsecaseError>>
{
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = brand_registration_sid {
        local_var_req_builder =
            local_var_req_builder.query(&[("BrandRegistrationSid", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchUsAppToPersonUsecaseSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchUsAppToPersonUsecaseError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_usecase(
    configuration: &configuration::Configuration,
) -> Result<ResponseContent<FetchUsecaseSuccess>, Error<FetchUsecaseError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchUsecaseSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchUsecaseError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_alpha_sender(
...
) -> Result<ResponseContent<ListAlphaSenderSuccess>, Error<ListAlphaSenderError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListAlphaSenderSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListAlphaSenderError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_brand_registrations(
...
) -> Result<ResponseContent<ListBrandRegistrationsSuccess>, Error<ListBrandRegistrationsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListBrandRegistrationsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListBrandRegistrationsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_brand_vetting(
...
) -> Result<ResponseContent<ListBrandVettingSuccess>, Error<ListBrandVettingError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = vetting_provider {
        local_var_req_builder =
            local_var_req_builder.query(&[("VettingProvider", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = page_size {
        local_var_req_builder =
            local_var_req_builder.query(&[("PageSize", &local_var_str.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListBrandVettingSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListBrandVettingError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_phone_number(
...
) -> Result<ResponseContent<ListPhoneNumberSuccess>, Error<ListPhoneNumberError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListPhoneNumberSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListPhoneNumberError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_short_code(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListShortCodeSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_us_app_to_person(
...
) -> Result<ResponseContent<ListUsAppToPersonSuccess>, Error<ListUsAppToPersonError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListUsAppToPersonSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListUsAppToPersonError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<ResponseContent<UpdateBrandRegistrationsSuccess>, Error<UpdateBrandRegistrationsError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateBrandRegistrationsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<UpdateBrandRegistrationsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
