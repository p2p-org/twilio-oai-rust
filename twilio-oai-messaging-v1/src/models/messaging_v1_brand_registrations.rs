...
pub struct MessagingV1BrandRegistrations {
    ...
    /// Brand feedback
    #[serde(rename = "brand_feedback", skip_serializing_if = "Option::is_none")]
    pub brand_feedback: Option<Vec<BrandFeedback>>,
    /// Brand score
    ...
    /// Government Entity
    #[serde(rename = "government_entity", skip_serializing_if = "Option::is_none")]
...
pub enum BrandFeedback {
    #[serde(rename = "TAX_ID")]
    TAXID,
    #[serde(rename = "STOCK_SYMBOL")]
    STOCKSYMBOL,
...
impl Default for BrandFeedback {
    fn default() -> BrandFeedback {
        Self::TAXID
    }
}
/// Identity Status
