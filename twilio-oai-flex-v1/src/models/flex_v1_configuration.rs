...
pub struct FlexV1Configuration {
    ...
    #[serde(
        rename = "call_recording_enabled",
        skip_serializing_if = "Option::is_none"
    )]
    pub call_recording_enabled: Option<bool>,
    /// The call recording webhook URL
    #[serde(
        rename = "call_recording_webhook_url",
        skip_serializing_if = "Option::is_none"
    )]
    pub call_recording_webhook_url: Option<String>,
    /// Flex Conversations channels' attachments configurations
    #[serde(rename = "channel_configs", skip_serializing_if = "Option::is_none")]
    pub channel_configs: Option<Vec<serde_json::Value>>,
    /// The SID of the chat service this user belongs to
    #[serde(
        rename = "chat_service_instance_sid",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "flex_insights_drilldown",
        skip_serializing_if = "Option::is_none"
    )]
    pub flex_insights_drilldown: Option<bool>,
    /// Object that controls workspace reporting
    #[serde(rename = "flex_insights_hr", skip_serializing_if = "Option::is_none")]
    pub flex_insights_hr: Option<serde_json::Value>,
    /// The SID of the Flex service instance
    #[serde(
        rename = "flex_service_instance_sid",
        skip_serializing_if = "Option::is_none"
    )]
    pub flex_service_instance_sid: Option<String>,
    /// URL to redirect to in case drilldown is enabled.
    #[serde(rename = "flex_url", skip_serializing_if = "Option::is_none")]
    pub flex_url: Option<String>,
    ...
    #[serde(
        rename = "messaging_service_instance_sid",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "queue_stats_configuration",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "serverless_service_sids",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "taskrouter_offline_activity_sid",
        skip_serializing_if = "Option::is_none"
    )]
...
impl FlexV1Configuration {
    pub fn new() -> FlexV1Configuration {
        FlexV1Configuration {
            ...
            date_created: None,
            date_updated: None,
            flex_insights_drilldown: None,
            flex_insights_hr: None,
