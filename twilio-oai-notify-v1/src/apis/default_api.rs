...
pub async fn create_binding(
...
) -> Result<ResponseContent<CreateBindingSuccess>, Error<CreateBindingError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateBindingSuccess> =
        ...
        let local_var_entity: Option<CreateBindingError> =
            serde_json::from_str(&local_var_content).ok();
...
pub async fn create_service(
    ...
    let default_alexa_notification_protocol_version =
        params.default_alexa_notification_protocol_version;
    let default_apn_notification_protocol_version =
        params.default_apn_notification_protocol_version;
    let default_fcm_notification_protocol_version =
        params.default_fcm_notification_protocol_version;
    let default_gcm_notification_protocol_version =
        params.default_gcm_notification_protocol_version;
