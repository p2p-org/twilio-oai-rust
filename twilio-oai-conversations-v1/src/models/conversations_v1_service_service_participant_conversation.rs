...
pub struct ConversationsV1ServiceServiceParticipantConversation {
    ...
    #[serde(
        rename = "participant_messaging_binding",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "participant_user_sid",
        skip_serializing_if = "Option::is_none"
    )]
    pub participant_user_sid: Option<String>,
}

impl ConversationsV1ServiceServiceParticipantConversation {
    pub fn new() -> ConversationsV1ServiceServiceParticipantConversation {
