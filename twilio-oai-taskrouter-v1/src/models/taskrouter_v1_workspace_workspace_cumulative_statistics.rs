...
pub struct TaskrouterV1WorkspaceWorkspaceCumulativeStatistics {
    ...
    #[serde(rename = "tasks_created", skip_serializing_if = "Option::is_none")]
    pub tasks_created: Option<i32>,
...
impl TaskrouterV1WorkspaceWorkspaceCumulativeStatistics {
    pub fn new() -> TaskrouterV1WorkspaceWorkspaceCumulativeStatistics {
