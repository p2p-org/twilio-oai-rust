...
pub async fn create_room(
    ...
    let empty_room_timeout = params.empty_room_timeout;
    let enable_turn = params.enable_turn;
    let large_room = params.large_room;
    let max_participant_duration = params.max_participant_duration;
    ...
    let unused_room_timeout = params.unused_room_timeout;
    ...
    let mut local_var_form_params = std::collections::HashMap::new();
    if let Some(local_var_param_value) = audio_only {
        local_var_form_params.insert("AudioOnly", local_var_param_value.to_string());
    }
    if let Some(local_var_param_value) = empty_room_timeout {
        local_var_form_params.insert("EmptyRoomTimeout", local_var_param_value.to_string());
    }
    if let Some(local_var_param_value) = enable_turn {
        local_var_form_params.insert("EnableTurn", local_var_param_value.to_string());
    }
    if let Some(local_var_param_value) = large_room {
        local_var_form_params.insert("LargeRoom", local_var_param_value.to_string());
    }
    if let Some(local_var_param_value) = max_participant_duration {
        local_var_form_params.insert("MaxParticipantDuration", local_var_param_value.to_string());
    }
    ...
    if let Some(local_var_param_value) = unused_room_timeout {
        local_var_form_params.insert("UnusedRoomTimeout", local_var_param_value.to_string());
    }
    ...
    if let Some(ref local_var_str) = grouping_sid {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("GroupingSid".to_owned(), p.to_string()))
