...
///
pub async fn fetch_messaging_country(
    configuration: &configuration::Configuration,
    params: FetchMessagingCountryParams,
) -> Result<ResponseContent<FetchMessagingCountrySuccess>, Error<FetchMessagingCountryError>> {
    ...
    let local_var_uri_str = format!(
        ...
        IsoCountry = crate::apis::urlencode(iso_country)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchMessagingCountrySuccess> =
        ...
        let local_var_entity: Option<FetchMessagingCountryError> =
            serde_json::from_str(&local_var_content).ok();
...
///
pub async fn fetch_phone_number_country(
    configuration: &configuration::Configuration,
    params: FetchPhoneNumberCountryParams,
) -> Result<ResponseContent<FetchPhoneNumberCountrySuccess>, Error<FetchPhoneNumberCountryError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchPhoneNumberCountrySuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchPhoneNumberCountryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn fetch_voice_country(
    configuration: &configuration::Configuration,
    params: FetchVoiceCountryParams,
) -> Result<ResponseContent<FetchVoiceCountrySuccess>, Error<FetchVoiceCountryError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchVoiceCountrySuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchVoiceCountryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn fetch_voice_number(
    configuration: &configuration::Configuration,
    params: FetchVoiceNumberParams,
) -> Result<ResponseContent<FetchVoiceNumberSuccess>, Error<FetchVoiceNumberError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchVoiceNumberSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchVoiceNumberError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn list_messaging_country(
    configuration: &configuration::Configuration,
    params: ListMessagingCountryParams,
) -> Result<ResponseContent<ListMessagingCountrySuccess>, Error<ListMessagingCountryError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListMessagingCountrySuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListMessagingCountryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn list_phone_number_country(
    configuration: &configuration::Configuration,
    params: ListPhoneNumberCountryParams,
) -> Result<ResponseContent<ListPhoneNumberCountrySuccess>, Error<ListPhoneNumberCountryError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListPhoneNumberCountrySuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListPhoneNumberCountryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn list_voice_country(
    configuration: &configuration::Configuration,
    params: ListVoiceCountryParams,
) -> Result<ResponseContent<ListVoiceCountrySuccess>, Error<ListVoiceCountryError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListVoiceCountrySuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListVoiceCountryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
