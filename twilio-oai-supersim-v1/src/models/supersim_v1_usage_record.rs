...
pub struct SupersimV1UsageRecord {
    ...
    #[serde(rename = "billed_unit", skip_serializing_if = "Option::is_none")]
    pub billed_unit: Option<String>,
    ...
    #[serde(rename = "data_total_billed", skip_serializing_if = "Option::is_none")]
    pub data_total_billed: Option<f32>,
