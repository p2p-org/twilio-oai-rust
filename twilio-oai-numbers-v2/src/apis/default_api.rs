...
/// struct for passing parameters to the method [`create_bundle_copy`]
#[derive(Clone, Debug, Default)]
pub struct CreateBundleCopyParams {
...
/// struct for passing parameters to the method [`create_replace_items`]
#[derive(Clone, Debug, Default)]
pub struct CreateReplaceItemsParams {
...
pub struct ListBundleParams {
    ...
    pub has_valid_until_date: Option<bool>,
    ...
    /// Date to filter Bundles having their `valid_until_date` before or after the specified date. Can be `ValidUntilDate>=` or `ValidUntilDate<=`. Both can be used in conjunction as well. [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) is the acceptable date format.
    pub valid_until_date2: Option<String>,
    /// Date to filter Bundles having their `valid_until_date` before or after the specified date. Can be `ValidUntilDate>=` or `ValidUntilDate<=`. Both can be used in conjunction as well. [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) is the acceptable date format.
    pub valid_until_date3: Option<String>,
    /// How many resources to return in each list page. The default is 50, and the maximum is 1000.
    pub page_size: Option<i32>,
}

/// struct for passing parameters to the method [`list_bundle_copy`]
#[derive(Clone, Debug, Default)]
pub struct ListBundleCopyParams {
    /// The unique string that we created to identify the Bundle resource.
    pub bundle_sid: String,
    /// How many resources to return in each list page. The default is 50, and the maximum is 1000.
    pub page_size: Option<i32>,
...
/// struct for typed successes of method [`create_bundle_copy`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateBundleCopySuccess {
    Status201(crate::models::NumbersV2RegulatoryComplianceBundleBundleCopy),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed successes of method [`create_replace_items`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateReplaceItemsSuccess {
    Status201(crate::models::NumbersV2RegulatoryComplianceBundleReplaceItems),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed successes of method [`list_bundle_copy`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListBundleCopySuccess {
    Status200(crate::models::ListBundleCopyResponse),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`create_bundle_copy`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateBundleCopyError {
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`create_replace_items`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateReplaceItemsError {
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`list_bundle_copy`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListBundleCopyError {
    UnknownValue(serde_json::Value),
}
...
pub async fn create_bundle(
...
) -> Result<ResponseContent<CreateBundleSuccess>, Error<CreateBundleError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateBundleSuccess> =
        ...
        let local_var_entity: Option<CreateBundleError> =
            serde_json::from_str(&local_var_content).ok();
...
pub async fn create_bundle_copy(
    configuration: &configuration::Configuration,
    params: CreateBundleCopyParams,
) -> Result<ResponseContent<CreateBundleCopySuccess>, Error<CreateBundleCopyError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        BundleSid = crate::apis::urlencode(bundle_sid)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateBundleCopySuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateBundleCopyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_evaluation(
...
) -> Result<ResponseContent<CreateEvaluationSuccess>, Error<CreateEvaluationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateEvaluationSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateEvaluationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_item_assignment(
    configuration: &configuration::Configuration,
    params: CreateItemAssignmentParams,
) -> Result<ResponseContent<CreateItemAssignmentSuccess>, Error<CreateItemAssignmentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateItemAssignmentSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateItemAssignmentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_replace_items(
    configuration: &configuration::Configuration,
    params: CreateReplaceItemsParams,
) -> Result<ResponseContent<CreateReplaceItemsSuccess>, Error<CreateReplaceItemsError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let bundle_sid = params.bundle_sid;
    let from_bundle_sid = params.from_bundle_sid;
    ...
    let mut local_var_form_params = std::collections::HashMap::new();
    local_var_form_params.insert("FromBundleSid", from_bundle_sid.to_string());
    local_var_req_builder = local_var_req_builder.form(&local_var_form_params);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateReplaceItemsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateReplaceItemsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_bundle(
...
) -> Result<ResponseContent<DeleteBundleSuccess>, Error<DeleteBundleError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteBundleSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteBundleError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_item_assignment(
    configuration: &configuration::Configuration,
    params: DeleteItemAssignmentParams,
) -> Result<ResponseContent<DeleteItemAssignmentSuccess>, Error<DeleteItemAssignmentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteItemAssignmentSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteItemAssignmentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_bundle(
    configuration: &configuration::Configuration,
    params: FetchBundleParams,
) -> Result<ResponseContent<FetchBundleSuccess>, Error<FetchBundleError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchBundleSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchBundleError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_evaluation(
    configuration: &configuration::Configuration,
    params: FetchEvaluationParams,
) -> Result<ResponseContent<FetchEvaluationSuccess>, Error<FetchEvaluationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchEvaluationSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchEvaluationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_item_assignment(
    configuration: &configuration::Configuration,
    params: FetchItemAssignmentParams,
) -> Result<ResponseContent<FetchItemAssignmentSuccess>, Error<FetchItemAssignmentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchItemAssignmentSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchItemAssignmentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_regulation(
    configuration: &configuration::Configuration,
    params: FetchRegulationParams,
) -> Result<ResponseContent<FetchRegulationSuccess>, Error<FetchRegulationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchRegulationSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchRegulationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_bundle(
    configuration: &configuration::Configuration,
    params: ListBundleParams,
) -> Result<ResponseContent<ListBundleSuccess>, Error<ListBundleError>> {
    let local_var_configuration = configuration;
    ...
    let iso_country = params.iso_country;
    let number_type = params.number_type;
    let has_valid_until_date = params.has_valid_until_date;
    let sort_by = params.sort_by;
    let sort_direction = params.sort_direction;
    let valid_until_date = params.valid_until_date;
    let valid_until_date2 = params.valid_until_date2;
    let valid_until_date3 = params.valid_until_date3;
    ...
    if let Some(ref local_var_str) = regulation_sid {
        local_var_req_builder =
            local_var_req_builder.query(&[("RegulationSid", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = number_type {
        local_var_req_builder =
            local_var_req_builder.query(&[("NumberType", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = has_valid_until_date {
        local_var_req_builder =
            local_var_req_builder.query(&[("HasValidUntilDate", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = sort_direction {
        local_var_req_builder =
            local_var_req_builder.query(&[("SortDirection", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = valid_until_date {
        local_var_req_builder =
            local_var_req_builder.query(&[("ValidUntilDate", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = valid_until_date2 {
        local_var_req_builder =
            local_var_req_builder.query(&[("ValidUntilDate<", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = valid_until_date3 {
        local_var_req_builder =
            local_var_req_builder.query(&[("ValidUntilDate>", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListBundleSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListBundleError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_bundle_copy(
    configuration: &configuration::Configuration,
    params: ListBundleCopyParams,
) -> Result<ResponseContent<ListBundleCopySuccess>, Error<ListBundleCopyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListBundleCopySuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListBundleCopyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_evaluation(
    configuration: &configuration::Configuration,
    params: ListEvaluationParams,
) -> Result<ResponseContent<ListEvaluationSuccess>, Error<ListEvaluationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListEvaluationSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListEvaluationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_item_assignment(
    configuration: &configuration::Configuration,
    params: ListItemAssignmentParams,
) -> Result<ResponseContent<ListItemAssignmentSuccess>, Error<ListItemAssignmentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListItemAssignmentSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListItemAssignmentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_regulation(
    configuration: &configuration::Configuration,
    params: ListRegulationParams,
) -> Result<ResponseContent<ListRegulationSuccess>, Error<ListRegulationError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = end_user_type {
        local_var_req_builder =
            local_var_req_builder.query(&[("EndUserType", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = iso_country {
        local_var_req_builder =
            local_var_req_builder.query(&[("IsoCountry", &local_var_str.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListRegulationSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListRegulationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_bundle(
...
) -> Result<ResponseContent<UpdateBundleSuccess>, Error<UpdateBundleError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateBundleSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<UpdateBundleError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
