...
pub struct NumbersV2RegulatoryComplianceSupportingDocument {
...
impl NumbersV2RegulatoryComplianceSupportingDocument {
    pub fn new() -> NumbersV2RegulatoryComplianceSupportingDocument {
