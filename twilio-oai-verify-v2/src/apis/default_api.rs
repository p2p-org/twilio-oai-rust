...
/// struct for typed successes of method [`fetch_access_token`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum FetchAccessTokenSuccess {
    Status200(crate::models::VerifyV2ServiceAccessToken),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed successes of method [`fetch_verification_attempts_summary`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum FetchVerificationAttemptsSummarySuccess {
    Status200(crate::models::VerifyV2VerificationAttemptsSummary),
    UnknownValue(serde_json::Value),
}
...
pub async fn create_access_token(
...
) -> Result<ResponseContent<CreateAccessTokenSuccess>, Error<CreateAccessTokenError>> {
    ...
    let factor_friendly_name = params.factor_friendly_name;
    let ttl = params.ttl;
    ...
    if let Some(local_var_param_value) = factor_friendly_name {
        local_var_form_params.insert("FactorFriendlyName", local_var_param_value.to_string());
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateAccessTokenSuccess> =
...
pub async fn create_bucket(
...
) -> Result<ResponseContent<CreateBucketSuccess>, Error<CreateBucketError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        ServiceSid = crate::apis::urlencode(service_sid),
        RateLimitSid = crate::apis::urlencode(rate_limit_sid)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateBucketSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateBucketError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_challenge(
...
) -> Result<ResponseContent<CreateChallengeSuccess>, Error<CreateChallengeError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        ServiceSid = crate::apis::urlencode(service_sid),
        Identity = crate::apis::urlencode(identity)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateChallengeSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateChallengeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_entity(
...
) -> Result<ResponseContent<CreateEntitySuccess>, Error<CreateEntityError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateEntitySuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_messaging_configuration(
    configuration: &configuration::Configuration,
    params: CreateMessagingConfigurationParams,
) -> Result<
    ResponseContent<CreateMessagingConfigurationSuccess>,
    Error<CreateMessagingConfigurationError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateMessagingConfigurationSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateMessagingConfigurationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_new_factor(
    configuration: &configuration::Configuration,
    params: CreateNewFactorParams,
) -> Result<ResponseContent<CreateNewFactorSuccess>, Error<CreateNewFactorError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(local_var_param_value) = metadata {
        local_var_form_params.insert("Metadata", local_var_param_value.to_string());
    }
    local_var_req_builder = local_var_req_builder.form(&local_var_form_params);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateNewFactorSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateNewFactorError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_notification(
...
) -> Result<ResponseContent<CreateNotificationSuccess>, Error<CreateNotificationError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        ServiceSid = crate::apis::urlencode(service_sid),
        Identity = crate::apis::urlencode(identity),
        ChallengeSid = crate::apis::urlencode(challenge_sid)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateNotificationSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateNotificationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_rate_limit(
...
) -> Result<ResponseContent<CreateRateLimitSuccess>, Error<CreateRateLimitError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateRateLimitSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateRateLimitError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_service(
    ...
    let default_template_sid = params.default_template_sid;
    ...
    if let Some(local_var_param_value) = default_template_sid {
        local_var_form_params.insert("DefaultTemplateSid", local_var_param_value.to_string());
    }
...
pub async fn create_verification(
...
) -> Result<ResponseContent<CreateVerificationSuccess>, Error<CreateVerificationError>> {
    let local_var_configuration = configuration;
    ...
    let template_custom_substitutions = params.template_custom_substitutions;
    let template_sid = params.template_sid;
    ...
    if let Some(local_var_param_value) = template_custom_substitutions {
        local_var_form_params.insert(
            "TemplateCustomSubstitutions",
            local_var_param_value.to_string(),
        );
    }
    if let Some(local_var_param_value) = template_sid {
        local_var_form_params.insert("TemplateSid", local_var_param_value.to_string());
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateVerificationSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateVerificationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_verification_check(
    configuration: &configuration::Configuration,
    params: CreateVerificationCheckParams,
) -> Result<ResponseContent<CreateVerificationCheckSuccess>, Error<CreateVerificationCheckError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateVerificationCheckSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<CreateVerificationCheckError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_webhook(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateWebhookSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_bucket(
...
) -> Result<ResponseContent<DeleteBucketSuccess>, Error<DeleteBucketError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteBucketSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteBucketError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_entity(
...
) -> Result<ResponseContent<DeleteEntitySuccess>, Error<DeleteEntityError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteEntitySuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteEntityError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_factor(
...
) -> Result<ResponseContent<DeleteFactorSuccess>, Error<DeleteFactorError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteFactorSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteFactorError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_messaging_configuration(
    configuration: &configuration::Configuration,
    params: DeleteMessagingConfigurationParams,
) -> Result<
    ResponseContent<DeleteMessagingConfigurationSuccess>,
    Error<DeleteMessagingConfigurationError>,
> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        ServiceSid = crate::apis::urlencode(service_sid),
        Country = crate::apis::urlencode(country)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteMessagingConfigurationSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteMessagingConfigurationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_rate_limit(
...
) -> Result<ResponseContent<DeleteRateLimitSuccess>, Error<DeleteRateLimitError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteRateLimitSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteRateLimitError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_webhook(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteWebhookSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_access_token(
    configuration: &configuration::Configuration,
    params: FetchAccessTokenParams,
) -> Result<ResponseContent<FetchAccessTokenSuccess>, Error<FetchAccessTokenError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchAccessTokenSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchAccessTokenError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_bucket(
    configuration: &configuration::Configuration,
    params: FetchBucketParams,
) -> Result<ResponseContent<FetchBucketSuccess>, Error<FetchBucketError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchBucketSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchBucketError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_challenge(
...
) -> Result<ResponseContent<FetchChallengeSuccess>, Error<FetchChallengeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchChallengeSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchChallengeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_entity(
...
) -> Result<ResponseContent<FetchEntitySuccess>, Error<FetchEntityError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchEntitySuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchEntityError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_factor(
    configuration: &configuration::Configuration,
    params: FetchFactorParams,
) -> Result<ResponseContent<FetchFactorSuccess>, Error<FetchFactorError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchFactorSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchFactorError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_form(
...
) -> Result<ResponseContent<FetchFormSuccess>, Error<FetchFormError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        "{}/v2/Forms/{FormType}",
        local_var_configuration.base_path,
        FormType = crate::apis::urlencode(form_type)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchFormSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchFormError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_messaging_configuration(
    configuration: &configuration::Configuration,
    params: FetchMessagingConfigurationParams,
) -> Result<
    ResponseContent<FetchMessagingConfigurationSuccess>,
    Error<FetchMessagingConfigurationError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchMessagingConfigurationSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchMessagingConfigurationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_rate_limit(
    configuration: &configuration::Configuration,
    params: FetchRateLimitParams,
) -> Result<ResponseContent<FetchRateLimitSuccess>, Error<FetchRateLimitError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchRateLimitSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchRateLimitError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_verification(
    configuration: &configuration::Configuration,
    params: FetchVerificationParams,
) -> Result<ResponseContent<FetchVerificationSuccess>, Error<FetchVerificationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchVerificationSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchVerificationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_verification_attempt(
    configuration: &configuration::Configuration,
    params: FetchVerificationAttemptParams,
) -> Result<ResponseContent<FetchVerificationAttemptSuccess>, Error<FetchVerificationAttemptError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchVerificationAttemptSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchVerificationAttemptError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_verification_attempts_summary(
    configuration: &configuration::Configuration,
    params: FetchVerificationAttemptsSummaryParams,
) -> Result<
    ResponseContent<FetchVerificationAttemptsSummarySuccess>,
    Error<FetchVerificationAttemptsSummaryError>,
> {
    let local_var_configuration = configuration;
    ...
    let country = params.country;
    let channel = params.channel;
    let destination_prefix = params.destination_prefix;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/Attempts/Summary", local_var_configuration.base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());

    if let Some(ref local_var_str) = service_sid {
        local_var_req_builder =
            local_var_req_builder.query(&[("ServiceSid", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = channel {
        local_var_req_builder =
            local_var_req_builder.query(&[("Channel", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = destination_prefix {
        local_var_req_builder =
            local_var_req_builder.query(&[("DestinationPrefix", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchVerificationAttemptsSummarySuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchVerificationAttemptsSummaryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn fetch_webhook(
    configuration: &configuration::Configuration,
    params: FetchWebhookParams,
) -> Result<ResponseContent<FetchWebhookSuccess>, Error<FetchWebhookError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchWebhookSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<FetchWebhookError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_bucket(
...
) -> Result<ResponseContent<ListBucketSuccess>, Error<ListBucketError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListBucketSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListBucketError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_challenge(
...
) -> Result<ResponseContent<ListChallengeSuccess>, Error<ListChallengeError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = factor_sid {
        local_var_req_builder =
            local_var_req_builder.query(&[("FactorSid", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListChallengeSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListChallengeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_entity(
...
) -> Result<ResponseContent<ListEntitySuccess>, Error<ListEntityError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListEntitySuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListEntityError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_factor(
    configuration: &configuration::Configuration,
    params: ListFactorParams,
) -> Result<ResponseContent<ListFactorSuccess>, Error<ListFactorError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListFactorSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListFactorError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_messaging_configuration(
    configuration: &configuration::Configuration,
    params: ListMessagingConfigurationParams,
) -> Result<
    ResponseContent<ListMessagingConfigurationSuccess>,
    Error<ListMessagingConfigurationError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListMessagingConfigurationSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListMessagingConfigurationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_rate_limit(
...
) -> Result<ResponseContent<ListRateLimitSuccess>, Error<ListRateLimitError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListRateLimitSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListRateLimitError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_verification_attempt(
    configuration: &configuration::Configuration,
    params: ListVerificationAttemptParams,
) -> Result<ResponseContent<ListVerificationAttemptSuccess>, Error<ListVerificationAttemptError>> {
    let local_var_configuration = configuration;
    ...
    let country = params.country;
    let channel = params.channel;
    let verify_service_sid = params.verify_service_sid;
    let verification_sid = params.verification_sid;
    let status = params.status;
    let page_size = params.page_size;
    ...
    if let Some(ref local_var_str) = channel_data_to {
        local_var_req_builder =
            local_var_req_builder.query(&[("ChannelData.To", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = country {
        local_var_req_builder =
            local_var_req_builder.query(&[("Country", &local_var_str.to_string())]);
    ...
    if let Some(ref local_var_str) = verify_service_sid {
        local_var_req_builder =
            local_var_req_builder.query(&[("VerifyServiceSid", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = verification_sid {
        local_var_req_builder =
            local_var_req_builder.query(&[("VerificationSid", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = status {
        local_var_req_builder =
            local_var_req_builder.query(&[("Status", &local_var_str.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListVerificationAttemptSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListVerificationAttemptError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<ResponseContent<ListVerificationTemplateSuccess>, Error<ListVerificationTemplateError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListVerificationTemplateSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<ListVerificationTemplateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_webhook(
...
) -> Result<ResponseContent<ListWebhookSuccess>, Error<ListWebhookError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListWebhookSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_bucket(
...
) -> Result<ResponseContent<UpdateBucketSuccess>, Error<UpdateBucketError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateBucketSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<UpdateBucketError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_challenge(
...
) -> Result<ResponseContent<UpdateChallengeSuccess>, Error<UpdateChallengeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateChallengeSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<UpdateChallengeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_factor(
...
) -> Result<ResponseContent<UpdateFactorSuccess>, Error<UpdateFactorError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateFactorSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<UpdateFactorError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_messaging_configuration(
    configuration: &configuration::Configuration,
    params: UpdateMessagingConfigurationParams,
) -> Result<
    ResponseContent<UpdateMessagingConfigurationSuccess>,
    Error<UpdateMessagingConfigurationError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateMessagingConfigurationSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<UpdateMessagingConfigurationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_rate_limit(
...
) -> Result<ResponseContent<UpdateRateLimitSuccess>, Error<UpdateRateLimitError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateRateLimitSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<UpdateRateLimitError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_verification(
...
) -> Result<ResponseContent<UpdateVerificationSuccess>, Error<UpdateVerificationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateVerificationSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<UpdateVerificationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_webhook(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateWebhookSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
